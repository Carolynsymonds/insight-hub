      ...
      <div>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6">
          <div className="flex items-center justify-center">
            {lead.logo_url ? (
              <img src={lead.logo_url} alt={lead.company || lead.full_name} className="h-12 w-12 rounded-full object-cover" />
            ) : (
              <div className="h-12 w-12 rounded-full bg-purple-500 flex items-center justify-center text-white font-semibold">
                {getInitials(lead.full_name || lead.company)}
              </div>
            )}
          </div>
